...
public class AnimatorTest {
  ...
  public void testGetVerboseAnimationMove() {
    ...
    assertEquals("shape 1 rectangle\n"
            + "motion 1 3 50 50 5 10 0 255 0 5 60 30 5 10 0 255 0\n\n", str);
  }
  ...
  public void testGetVerboseAnimationScale() {
    ...
    String str = am.getVerboseAnimation();
    assertEquals("shape 1 rectangle\n"
            + "motion 1 3 50 50 5 10 0 255 0 5 50 50 10 20 0 255 0\n\n", str);
  }
  ...
  public void testGetVerboseAnimationChangeColor() {
    ...
    String str = am.getVerboseAnimation();
    assertEquals("shape 1 rectangle\n"
            + "motion 1 6 50 50 5 10 0 255 0 8 50 50 5 10 0 0 255\n\n", str);
  }
